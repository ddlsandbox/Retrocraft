...
public class GuiMultifurnace extends GuiContainer {
	...
	private static final ResourceLocation texture = new ResourceLocation(RetroCraft.modId, "textures/gui/multifurnace.png");
	private TileMultifurnace tileEntity;

	public GuiMultifurnace(InventoryPlayer invPlayer, TileMultifurnace tileInventoryFurnace) {
		super(new ContainerMultifurnace(invPlayer, tileInventoryFurnace));
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int x, int y) {
		...
		for (int i = 0; i < TileMultifurnace.FUEL_SLOTS_COUNT; ++i) {
