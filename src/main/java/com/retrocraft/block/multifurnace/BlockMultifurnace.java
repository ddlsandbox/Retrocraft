 ...
 * //Note that in 1.10.*, extending BlockContainer can cause rendering problems if you don't extend getRenderType()
 ...
 //  need to implement.
 */
public class BlockMultifurnace extends BlockTileEntity<TileMultifurnace>
{
	...
	@Override
	public BlockMultifurnace setCreativeTab(CreativeTabs tab) {
	...
	@Nullable
	@Override
	public TileMultifurnace createTileEntity(World world, IBlockState state) {
...
//		}
	...
	{
		TileEntity tileEntity = worldIn.getTileEntity(pos);
		if (tileEntity instanceof TileMultifurnace) {
			TileMultifurnace tileInventoryFurnace = (TileMultifurnace)tileEntity;
