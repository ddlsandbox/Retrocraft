...
public class TESREnchanter extends TileEntitySpecialRenderer<TileEntityEnchanter> {
    
    private static final ResourceLocation TEXTURE_BOOK = new ResourceLocation("retrocraft:textures/entity/book.png");
    private final ModelBook modelBook = new ModelBook();
    
    @Override
    public void renderTileEntityAt (TileEntityEnchanter te, double x, double y, double z, float partialTicks, int destroyStage) {
        ...
        f3 = (f3 - MathHelper.floor(f3)) * 1.6F - 0.3F;
