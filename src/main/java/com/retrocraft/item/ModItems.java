...
public class ModItems {
  ...
  public static ItemManoliumArmor manolaziumFeet;
    ...
    manoliumHead = register(new ItemManoliumArmor(ArmorMaterials.manoliumArmorMaterial, "head_manolium", 0, EntityEquipmentSlot.HEAD).setCreativeTab(RetroCraft.creativeTab));
    manolaziumHead = register(new ItemManoliumArmor(ArmorMaterials.manolaziumArmorMaterial, "head_manolazium", 0, EntityEquipmentSlot.HEAD).setCreativeTab(RetroCraft.creativeTab));
    
    manoliumChest = register(new ItemManoliumArmor(ArmorMaterials.manoliumArmorMaterial, "chest_manolium", 0, EntityEquipmentSlot.CHEST).setCreativeTab(RetroCraft.creativeTab));
    manolaziumChest = register(new ItemManoliumArmor(ArmorMaterials.manolaziumArmorMaterial, "chest_manolazium", 0, EntityEquipmentSlot.CHEST).setCreativeTab(RetroCraft.creativeTab));
    
    manoliumLegs = register(new ItemManoliumArmor(ArmorMaterials.manoliumArmorMaterial, "legs_manolium", 0, EntityEquipmentSlot.LEGS).setCreativeTab(RetroCraft.creativeTab));
    manolaziumLegs = register(new ItemManoliumArmor(ArmorMaterials.manolaziumArmorMaterial, "legs_manolazium", 0, EntityEquipmentSlot.LEGS).setCreativeTab(RetroCraft.creativeTab));
    
    manoliumFeet = register(new ItemManoliumArmor(ArmorMaterials.manoliumArmorMaterial, "feet_manolium", 0, EntityEquipmentSlot.FEET).setCreativeTab(RetroCraft.creativeTab));
    manolaziumFeet = register(new ItemManoliumArmor(ArmorMaterials.manolaziumArmorMaterial, "feet_manolazium", 0, EntityEquipmentSlot.FEET).setCreativeTab(RetroCraft.creativeTab));
		...
		diamondHammer = register(new ToolHammer(ToolMaterial.DIAMOND, "hammer_diamond").setCreativeTab(RetroCraft.creativeTab));
		...
		manolaziumHammer = register(new ToolHammer(RetroCraft.manolaziumToolMaterial, "hammer_manolazium").setCreativeTab(RetroCraft.creativeTab));

		stoneExcavator = register(new ToolExcavator(ToolMaterial.STONE, "excavator_stone").setCreativeTab(RetroCraft.creativeTab));
    ironExcavator = register(new ToolExcavator(ToolMaterial.IRON, "excavator_iron").setCreativeTab(RetroCraft.creativeTab));
    goldExcavator = register(new ToolExcavator(ToolMaterial.GOLD, "excavator_gold").setCreativeTab(RetroCraft.creativeTab));
    diamondExcavator = register(new ToolExcavator(ToolMaterial.DIAMOND, "excavator_diamond").setCreativeTab(RetroCraft.creativeTab));
		...
		manolaziumExcavator = register(new ToolExcavator(RetroCraft.manolaziumToolMaterial, "excavator_manolazium").setCreativeTab(RetroCraft.creativeTab));
		
		stoneStreamAxe = register(new ToolStreamAxe(ToolMaterial.STONE, "streamaxe_stone").setCreativeTab(RetroCraft.creativeTab));
    ironStreamAxe = register(new ToolStreamAxe(ToolMaterial.IRON, "streamaxe_iron").setCreativeTab(RetroCraft.creativeTab));
    goldStreamAxe = register(new ToolStreamAxe(ToolMaterial.GOLD, "streamaxe_gold").setCreativeTab(RetroCraft.creativeTab));
    diamondStreamAxe = register(new ToolStreamAxe(ToolMaterial.DIAMOND, "streamaxe_diamond").setCreativeTab(RetroCraft.creativeTab));
// why it fails with manolium?
		...
		manolaziumStreamAxe = register(new ToolStreamAxe(ToolMaterial.DIAMOND, "streamaxe_manolazium").setCreativeTab(RetroCraft.creativeTab));
		...
		manolaziumETool = register(new ToolEverything(RetroCraft.manolaziumToolMaterial, "etool_manolazium").setCreativeTab(RetroCraft.creativeTab));
