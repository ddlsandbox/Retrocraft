...
public class TeleportCreationHandler implements IVillageCreationHandler
{

  @Override
  public StructureVillagePieces.PieceWeight getVillagePieceWeight(Random random, int size)
  {
    return new StructureVillagePieces.PieceWeight(ComponentVillageTeleport.class, 3, 1);
  }

  @Override
  public Class<? extends StructureVillagePieces.Village> getComponentClass()
  {
    return ComponentVillageTeleport.class;
  }
  ...
  {
    return ComponentVillageTeleport.buildComponent(villagePiece, startPiece, pieces, random, x, y, z, facing, type);
  }
