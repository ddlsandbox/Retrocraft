...
public class House1CreationHandler implements IVillageCreationHandler
{

  @Override
  public StructureVillagePieces.PieceWeight getVillagePieceWeight(Random random, int size)
  {
    return new StructureVillagePieces.PieceWeight(ComponentVillageHouse1.class, 3, 1);
  }

  @Override
  public Class<? extends StructureVillagePieces.Village> getComponentClass()
  {
    return ComponentVillageHouse1.class;
  }
  ...
  {
    return ComponentVillageHouse1.buildComponent(villagePiece, startPiece, pieces, random, x, y, z, facing, type);
  }
