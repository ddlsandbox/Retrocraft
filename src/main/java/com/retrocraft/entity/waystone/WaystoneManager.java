...
public class WaystoneManager
{
  ...
  public static void sendPlayerWaystones(EntityPlayer player)
  {
    if (player instanceof EntityPlayerMP)
    {
      ...
      RetroCraft.network.sendTo(new MessageWaystones(
  ...
  public static void addPlayerWaystone(EntityPlayer player,
      WaystoneEntry waystone)
  {
    NBTTagCompound tagCompound = PlayerWaystoneHelper
        .getOrCreateWaystonesTag(player);
    NBTTagList tagList = tagCompound.getTagList(
        PlayerWaystoneHelper.WAYSTONE_LIST, Constants.NBT.TAG_COMPOUND);
    ...
    if (dimensionWarp)
    {
      ...
      if (server != null)
      {
        server.getPlayerList().transferPlayerToDimension(
            ...
            new TeleporterWaystone((WorldServer) player.world));
      }
    }
