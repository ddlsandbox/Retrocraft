...
public class GuiButtonSortWaystone extends GuiButtonExt
{
  ...
  public void drawButton(Minecraft mc, int mouseX, int mouseY)
  {
    ...
    if (this.visible && mouseY >= parentButton.yPosition
        && mouseY < parentButton.yPosition + parentButton.height)
    {
      ...
      if (hovered)
      {
        Gui.drawModalRectWithCustomSizedTexture(xPosition - 5,
            yPosition - 5 - (sortDir == 1 ? 15 : 0),
