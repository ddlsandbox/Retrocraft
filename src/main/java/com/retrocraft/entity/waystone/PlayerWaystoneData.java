...
public class PlayerWaystoneData
{
  ...
  public PlayerWaystoneData(WaystoneEntry[] entries, long lastFreeWarp,
  ...
  public static PlayerWaystoneData fromPlayer(EntityPlayer player)
  {
    ...
    long lastFreeWarp = tagCompound
        .getLong(PlayerWaystoneHelper.LAST_FREE_WARP);
    long lastWarpStoneUse = tagCompound
        .getLong(PlayerWaystoneHelper.LAST_WARP_STONE_USE);
